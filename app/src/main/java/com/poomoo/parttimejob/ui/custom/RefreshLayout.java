...
//            mListView = (ListView) childView.findViewById(R.id.list_main);
//            // 设置滚动监听器给ListView, 使得滚动的情况下也可以自动加载
//            mListView.setOnScrollListener(this);
//            LogUtils.i("找到listview");
//        } else
//            LogUtils.i("没有找到listview");
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        LogUtils.i("dispatchTouchEvent" + action);
        switch (action) {
    ...
    private boolean canLoad() {
        LogUtils.i("canLoad"+isBottom()+":"+isLoading+":"+isPullUp());
